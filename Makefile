...
Morpheus_Matrix_Tests.exe: Morpheus_Matrix_Tests.o Morpheus_Matrix.o Morpheus_Vector.o
	g++ -o Morpheus_Matrix_Tests.exe Morpheus_Matrix_Tests.o Morpheus_Matrix.o Morpheus_Vector.o

Morpheus_Vector_addScaleTest.exe: Morpheus_Vector_addScaleTest.o Morpheus_Vector.o
	g++ -o Morpheus_Vector_addScaleTest.exe Morpheus_Vector_addScaleTest.o Morpheus_Vector.o

Morpheus_Vector_normTest.exe: Morpheus_Vector_normTest.o Morpheus_Vector.o
	g++ -o Morpheus_Vector_normTest.exe Morpheus_Vector_normTest.o Morpheus_Vector.o
